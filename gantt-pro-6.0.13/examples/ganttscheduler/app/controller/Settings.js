Ext.define('Gnt.examples.ganttscheduler.controller.Settings', {
    ...
    getColorOfNode: function (selector, styleName) {
        ...
        var node = this.getGantt().getEl().selectNode(selector),
            ...
            rgb = color && color.replace( /^\D+/g, '').split(',');
    ...
    onShow: function (settings) {
        ...
        var hexTaskBar = this.getColorOfNode('.sch-gantt-task-bar:not(.sch-event-segmented)', 'background-color');
